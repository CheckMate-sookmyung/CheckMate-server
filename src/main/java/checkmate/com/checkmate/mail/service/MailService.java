...
import static checkmate.com.checkmate.global.codes.ErrorCode.MAIL_NOT_FOUND;
...
public class MailService {
    ...
    public MailResponseDto getMailContent(Accessor accessor, Long eventId, MailType mailType) {
        ...
        if (mail == null)
            throw new GeneralException(MAIL_NOT_FOUND);
    ...
    public void createRemindMail(Event event, MailRequestDto mailRequestDto) {
        ...
        System.out.println(mailRequestDto.getMailType());
        Mail mail = Mail.builder()
                .mailType(mailRequestDto.getMailType())
                .mailTitle(title)
